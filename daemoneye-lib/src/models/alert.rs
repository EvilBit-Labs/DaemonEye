...
impl AlertId {
    ...
    ///
    /// ```rust
    /// use daemoneye_lib::models::alert::AlertId;
...
impl AlertContext {
    ...
    ///
    /// ```
    /// let ctx = daemoneye_lib::models::alert::AlertContext::new();
    ...
    ///
    /// ```rust
    /// use daemoneye_lib::models::alert::AlertContext;
    ...
    ///
    /// ```rust
    /// use daemoneye_lib::models::alert::{AlertContext, AlertError};
