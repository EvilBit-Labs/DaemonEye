// =============================================================================
// BUNDLED SENTINELAGENT BINARY
// =============================================================================
// This file contains the bundled sentinelagent binary for distribution.
// It re-exports the sentinelagent functionality while allowing the sentinel package
// to have its own dependencies and versioning.
//
// BUNDLING STRATEGY:
// - This is a copy of the implementation from sentinelagent/src/main.rs
...
//
// SENTINELAGENT ROLE:
// - User-space orchestrator for detection and alerting
// - Minimal privileges, outbound-only network connections
// - Read/write access to event store, manages procmond lifecycle
// - SQL-based detection engine, multi-channel alerting
// - IPC client for communicating with procmond
//
// ARCHITECTURE:
// - Translates complex SQL rules into simple protobuf tasks for procmond
// - Executes detection rules against collected process data
// - Manages alert delivery to multiple sinks (syslog, webhook, email)
// - Provides health monitoring and telemetry collection
// =============================================================================
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    // Parse CLI arguments first - this will handle --help and --version
    let _cli = Cli::parse();
